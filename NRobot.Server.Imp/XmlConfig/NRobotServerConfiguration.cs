...
namespace NRobot.Server.Imp.XmlConfig
{
    ...
    public class NRobotServerConfiguration : ConfigurationSection
    {
        ...
        {
            return (NRobotServerConfiguration)ConfigurationManager.GetSection(CConfigSection)
                ?? new NRobotServerConfiguration();
        }
        ...
        {
            get { return (PortElement)this["port"] ?? new PortElement(); }
        }
    }
}
